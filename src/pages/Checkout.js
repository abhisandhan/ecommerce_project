              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <ul role="list">
                  {user.addresses.map((address,index) => (
                    <li
                      key={index}
                      className="flex justify-between gap-x-6 px-5 py-5 mb-5 border-solid border-2 border-gray-200"
                    >
          ...
          <div className="mx-auto mt-12 bg-white max-w-7xl px-2 sm:px-3 lg:px-4">
            ...
            <div className="border-t border-gray-200 px-2 py-4 sm:px-2">
              ...
              <div className="mt-6">
                <div
                onClick={handleOrder}
                className="flex cursor-pointer items-center justify-center rounded-md border border-tranparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                >
                  Order Now
                </div>
              </div>
